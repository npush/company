 ...
 * Time: 3:47 PM
 */
class Stableflow_Company_Model_Address_Abstract extends Mage_Core_Model_Abstract{

    /**
     * Possible company address types
     */
    ...
    {
        return Mage::getSingleton('company/address_config');
    }
