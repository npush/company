 ...
 * Time: 6:22 PM
 */
class Stableflow_Company_Block_Adminhtml_Parser_Helper_File extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('company/parser')->getFileBaseUrl() . $url;
            }
