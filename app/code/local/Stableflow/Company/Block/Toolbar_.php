 ...
 * Time: 5:49 PM
 */
class Stableflow_Company_Block_Toolbar extends Mage_Core_Block_Template{
    ...
    protected function _construct(){
        ...
        $this->setCollection(Mage::getModel('company/company')->getCollection());
        $this->setTemplate('company/toolbar.phtml');
    }
