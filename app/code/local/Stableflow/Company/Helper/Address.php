 ...
 */
class Stableflow_Company_Helper_Address extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function getConfig($key, $store = null)
    {
        ...
        if (!isset($this->_config[$websiteId])) {
            $this->_config[$websiteId] = Mage::getStoreConfig('company/address', $store);
        }
    ...
    public function getStreetLines($store = null)
    {
        ...
        if (!isset($this->_streetLines[$websiteId])) {
            $attribute = Mage::getSingleton('eav/config')->getAttribute('company_address', 'street');
    ...
    {
        $format = Mage::getSingleton('company/address_config')->getFormatByCode($code);
    ...
    /**
     * Return array of Company Address Attributes
     *
     * @return array
     */
    public function getAttributes()
    {
        if (is_null($this->_attributes)) {
            ...
            foreach ($config->getEntityAttributeCodes('company_address') as $attributeCode) {
                $this->_attributes[$attributeCode] = $config->getAttribute('company_address', $attributeCode);
            }
        }
    ...
    public function getAttributeValidationClass($attributeCode)
    {
        ...
        $attribute = isset($this->_attributes[$attributeCode]) ? $this->_attributes[$attributeCode]
            : Mage::getSingleton('eav/config')->getAttribute('company_address', $attributeCode);
        ...
        if (in_array($attributeCode, array('firstname', 'middlename', 'lastname', 'prefix', 'suffix', 'taxvat'))) {
            ...
            $customerAttribute = Mage::getSingleton('eav/config')->getAttribute('company_address', $attributeCode);
