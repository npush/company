...
var Layout = function ($) {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            content.attr('style', 'min-height:' + height + 'px' + bbbb );
        }
    };

    // Handle sidebar menu links
    var handleSidebarMenuActiveLink = function(mode, el) {
        console.log('// Handle sidebar menu links');
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar-menu').on('click', /*'li > a.nav-toggle,*/ 'li, li > a > span.nav-toggle', function (e) {
...
$j(document).ready(function () {
    $(document).on('click', '.info-content', function () {
        if ($('.info-content').hasClass('active'))
        {
